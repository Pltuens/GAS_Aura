...
void UAuraAbilitySystemComponent::AddCharacterAbilities(const TArray<TSubclassOf<UGameplayAbility>>& StartupAbilities)
{
    for (const TSubclassOf<UGameplayAbility> AbilityClass : StartupAbilities)
    {
        ...
        {
            // 3. 【核心缺漏补全】将技能蓝图里设置的 StartupInputTag 添加到 Spec 的动态标签容器中
...
void UAuraAbilitySystemComponent::ClientEffectedApplied_Implementation(UAbilitySystemComponent* AbilitySystemComponent, const FGameplayEffectSpec& EffectSpec, FActiveGameplayEffectHandle ActiveEffectHandle)
{
